...
const ScrollStack = ({
  ...
  scaleEndPosition = "10%",
  baseScale = 0.85,
  scaleDuration = 0.5, // kept for API compatibility even though not used
  rotationAmount = 0,
  blurAmount = 0,
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const endElement = useWindowScroll
      ...
      : (scrollContainer?.querySelector(".scroll-stack-end") as HTMLElement | null);
  ...
  useLayoutEffect(() => {
    ...
    const cards = (useWindowScroll
      ...
      : Array.from(scroller?.querySelectorAll(".scroll-stack-card") ?? [])) as HTMLDivElement[];
